...
L['AUX_CMD_1'] = 'Масштаб'
L['AUX_CMD_10'] = 'Результат распыления в подсказке'
L['AUX_CMD_11'] = 'Очистка кэша предметов'
L['AUX_CMD_12'] = 'Наполнение кэша'
...
L['AUX_CMD_4'] = 'Стоимость изготовления предмета в окне профессии'
L['AUX_CMD_5'] = 'Стоимость предмета на аукционе в подсказке'
L['AUX_CMD_6'] = 'Ежедневная стоимость в подсказке'
L['AUX_CMD_7'] = 'Стоимость покупки у торговца в подсказке'
L['AUX_CMD_8'] = 'Стоимость продажи торговцу в подсказке'
L['AUX_CMD_9'] = 'Стоимость распыления в подсказке'
